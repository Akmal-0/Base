#ifndef ROBOT_2_CONFIG_H
#define ROBOT_2_CONFIG_H
...
#define ROBOT_2 OMNI                    // Omniwheel robot
...
#define ROBOT_DIAMETER 0.2426  //242.6     // distance between left and right wheels
#define ROBOT_RADIUS 0.1213    //121.3
#define PWM_BITS 8
...
// encoder in array
const int enca[3] = { MOTOR1_ENCODER_A, MOTOR2_ENCODER_A, MOTOR3_ENCODER_A};

const int encb[3] = { MOTOR1_ENCODER_B, MOTOR2_ENCODER_B, MOTOR3_ENCODER_B};
